            ...
            for row in range(s.nrows):
                ...
                if row == 0:
                    ...
                    try:
                        ...
                        print(f"error: no hay costo para llave {origin},{geo_destiny_group}")
        ...
        if s.name == 'BBDD Destino': # Obtener dict sigla:cuidad
            ...
            for row in range(1, s.nrows):
                ...
                if row == 1:
                    ...
                    initials_region_code[(dest_initials, origin)] = str(code).replace('.0', '')
                    initials_to_zone[dest_initials] = zone
    return ref_order, order_sku, basecodes, store_city, city_zone, initials_region_code, initials_to_zone
